...
public class AppRTCAudioManager {
     ...
     * Construction.
     */
    public static com.myhexaville.androidwebrtc.app_rtc_sample.web_rtc.AppRTCAudioManager create(Context context) {
        return new com.myhexaville.androidwebrtc.app_rtc_sample.web_rtc.AppRTCAudioManager(context);
    }
