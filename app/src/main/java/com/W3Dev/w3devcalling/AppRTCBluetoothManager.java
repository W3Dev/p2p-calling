...
public class AppRTCBluetoothManager {
     ...
     * Construction.
     */
    static com.myhexaville.androidwebrtc.app_rtc_sample.web_rtc.AppRTCBluetoothManager create(Context context, AppRTCAudioManager audioManager) {
        Log.d(TAG, "create" + AppRTCUtils.getThreadInfo());
        return new com.myhexaville.androidwebrtc.app_rtc_sample.web_rtc.AppRTCBluetoothManager(context, audioManager);
    }
